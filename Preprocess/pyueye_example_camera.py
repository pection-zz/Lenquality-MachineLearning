...
class Camera:
    ...
    def get_format_list(self):
        ...
        return format_list
    def set_Saturation(self,data1,data2):
        SetBufferSat = ueye.BUFFER_CONVERSION_PARAMS
        SetBufferSat.DestSaturationU = ueye.int(data1)
        SetBufferSat.DestSaturationV = ueye.int(data2)
